...
describe("Get Post by PostId route", () => {
  //DB Connection Setup
  ...
  //Test - Return a specific post
  it("should return specific post details upon entering the postId", async () => {
    //Test
    const response = await request(app)
      .get(`/api/post/${user1PostId}`)
      .set("Authorization", `Bearer ${user1Token}`)
